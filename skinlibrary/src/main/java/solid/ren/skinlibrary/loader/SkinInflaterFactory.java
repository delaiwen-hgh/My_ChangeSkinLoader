        ...
        for (int i = 0; i < attrs.getAttributeCount(); i++) {//遍历当前View的属性
            ...
            if ("style".equals(attrName)) {//style theme
                ...
                if (textColor != -1 && textColorId != -1) {
                    ...
                    SkinAttr skinAttr = AttrFactory.get("textColor", textColorId, entryName, typeName);//是否支持此属性textcolor
                    if (skinAttr != null) {
                ...
                if (background != -1 && backgroundId != -1) {
                    ...
                    SkinAttr skinAttr = AttrFactory.get("background", backgroundId, entryName, typeName);//是否支持此属性background
                    if (skinAttr != null) {
                        viewAttrs.add(skinAttr);
                    }
